...
/* Topic: Sorting */
/* File name: assignment14.c*/
/* Date: August 23, 2017 */
/* Objective: B Trees*/
/* OS - macOS Sierra 10.12.5 */
/* Compiler - gcc */
/* References - http://see-programming.blogspot.com/ */
/****************************************************/
...
int main() {
    ...
    ifp = fopen("btreeinput.doc", "r");
    ofp = fopen("assignment14out.doc", "w+");
    if (NULL == ifp) {
    ...
    for (int i = 0; fscanf(ifp, "%d%*c", &val) != EOF; i++) {
            insertion(val);
    }
